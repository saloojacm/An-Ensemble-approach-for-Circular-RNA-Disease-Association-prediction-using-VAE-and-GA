# -*- coding: utf-8 -*-
"""v20_GAAE_AugmentationCDAipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1AMX-7mJZtV2TZS1C2DOz17CQXael-oiF
"""
...
x1,x2=transfer_array_format(np.array(DD))   #x1 circRNAfea, x2 diseasefea
x1= np.concatenate((x1, x2 ), axis = 1) #axis=1 , rowwoise concatenation x1-(1950,650)
labels=laba+ll        #labels-1950

print("SMOTE RES X")
sm = SMOTE(random_state=42)
X_res, y_res = sm.fit_resample(x1, labels)

#split data
X_train, X_test, y_train, y_test = train_test_split(X_res,np.array(y_res), test_size=0.2, random_state=42)
...
def GA(VAEoutput_data,y_train):
  estimator = RandomForestClassifier(n_estimators=10,random_state=48)
...
VAE=autoencoder.predict(X_train)
GAselectedfea=GA(VAE,y_train)
Gfeature=GAdata(VAE,GAselectedfea)
Gfeature=np.array(Gfeature).astype(float)
#********testing****************
...
outputModel1=RandomForestClassifier(n_estimators=200,random_state=40)
